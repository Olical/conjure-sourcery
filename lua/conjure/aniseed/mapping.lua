...
local function _1_(...)
  _0_0["aniseed/local-fns"] = {require = {core = "conjure.aniseed.core", eval = "conjure.aniseed.eval", fennel = "conjure.aniseed.fennel", nu = "conjure.aniseed.nvim.util", nvim = "conjure.aniseed.nvim", str = "conjure.aniseed.string", test = "conjure.aniseed.test"}}
  return {require("conjure.aniseed.eval"), require("conjure.aniseed.test"), require("conjure.aniseed.core"), require("conjure.aniseed.fennel"), require("conjure.aniseed.nvim"), require("conjure.aniseed.nvim.util"), require("conjure.aniseed.string")}
end
local _2_ = _1_(...)
local eval = _2_[1]
local test = _2_[2]
