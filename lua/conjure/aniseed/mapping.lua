...
local function init()
  ...
  nu["fn-bridge"]("AniseedEval", "conjure.aniseed.mapping", "eval")
...
return {["aniseed/module"] = "conjure.aniseed.mapping", ["eval-file"] = eval_file, ["eval-range"] = eval_range, ["eval-selection"] = eval_selection, ["run-all-tests"] = run_all_tests, ["run-tests"] = run_tests, eval = eval, init = init, selection = selection}
