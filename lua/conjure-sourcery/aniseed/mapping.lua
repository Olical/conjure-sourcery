...
local function init()
  nu["fn-bridge"]("AniseedSelection", "conjure-sourcery.aniseed.mapping", "selection")
  nu["fn-bridge"]("AniseedEval", "conjure-sourcery.aniseed.mapping", "eval")
  nu["fn-bridge"]("AniseedEvalFile", "conjure-sourcery.aniseed.mapping", "eval-file")
  nu["fn-bridge"]("AniseedEvalRange", "conjure-sourcery.aniseed.mapping", "eval-range", {range = true})
  nu["fn-bridge"]("AniseedEvalSelection", "conjure-sourcery.aniseed.mapping", "eval-selection")
  nu["fn-bridge"]("AniseedRunTests", "conjure-sourcery.aniseed.mapping", "run-tests")
  nu["fn-bridge"]("AniseedRunAllTests", "conjure-sourcery.aniseed.mapping", "run-all-tests")
...
return {["aniseed/module"] = "conjure-sourcery.aniseed.mapping", ["eval-file"] = eval_file, ["eval-range"] = eval_range, ["eval-selection"] = eval_selection, ["run-all-tests"] = run_all_tests, ["run-tests"] = run_tests, eval = eval, init = init, selection = selection}
